...
from data.cva6_requirements import Requirement, get_all_requirements
from specguard import assess_dataset
from specguard.smell_detector import SmellHit
...
def main() -> None:
    ...
    output_path = Path(__file__).parent.parent / "results" / "specguard_graph.cypher"
