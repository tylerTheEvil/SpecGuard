...
# Add project root (parent of 'specguard' package) to sys.path
_PROJECT_ROOT = Path(__file__).resolve().parent.parent
sys.path.insert(0, str(_PROJECT_ROOT))

from data.cva6_requirements import get_all_requirements
...
from specguard.smell_detector import analyze_dataset
...
def build_demo_graph() -> MockGraph:
    ...
    from specguard.smell_detector import analyze_requirement
    for req in cva6_reqs:
